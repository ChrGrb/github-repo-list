...
const RepositoryCard = ({ repository, onStar }: Props) => {
    return (
        <div data-testid="repository-card">
            <span className="flex flex-col sm:flex-row justify-between w-full rounded-md text-slate-100 px-3 my-5">
                ...
                <div className="mt-4 sm:mt-0">
                    <button className="flex gap-2 bg-slate-100 text-slate-500 font-light px-3 py-1 rounded-md hover:bg-green-300 hover:text-slate-100 transition-colors" onClick={() => onStar(repository)}>
